...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/red-sky-64d6)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/red-sky-64d6
```

A live public deployment of this template is available at [https://red-sky-64d6.templates.workers.dev](https://red-sky-64d6.templates.workers.dev)
